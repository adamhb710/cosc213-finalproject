...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        ...
        $stmt->bind_param("ssdisi", $name, $description, $price, $stock, $image_url, $active); // Type matching, string, string, double, integer, string and integer.
...
$stock_value = isset($_POST['stock']) ? htmlspecialchars($_POST['stock']) : '0';
$image_url_value = isset($_POST['image_url']) ? htmlspecialchars($_POST['image_url']) : '';
$active_checked = (!isset($_POST['active']) || $_POST['active']) ? 'checked' : '';
